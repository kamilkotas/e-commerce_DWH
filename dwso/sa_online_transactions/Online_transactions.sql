...
CREATE FOREIGN TABLE IF NOT EXISTS online.transactions  (
			...
			OPTIONS ( filename '/home/kamil/Desktop/Data_set/Online_ Transactions.csv', format 'csv', HEADER 'TRUE' );
		
		
-- Creating source table for transactions made online from customers.

CREATE TABLE IF NOT EXISTS online.src_online_transactions  (
				Transaction_ID						VARCHAR(255),
				TransactionNo						VARCHAR(255),
				Date_of_tr							VARCHAR(255),
				Product_category_id					VARCHAR(255),
...
INSERT INTO online.src_online_transactions
...
SELECT * FROM online.src_online_transactions
